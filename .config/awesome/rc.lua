...
naughty.config.icon_dirs = { awful.util.getdir("config") .. "/naughtyicons/",  "/usr/share/pixmaps/" }
...
run_once("urxvtd")
run_once("mpd"," /home/pfault/.mpd/mpd.conf")
run_once("mpdscribble")
run_once("g15-desktop-service")
...
for s = 1, screen.count() do
    ...
    mygraphbox[s].widgets = {
        {
            cpuicon, cpufreq, cpugraph0, cpupct0, cpugraph1, cpupct1, cpugraph2, cpupct2, cpugraph3, cpupct3, tab,
            memicon, memused, membar, mempct, tab,
            swapicon, swapused, swapbar, swappct, tab,
            rooticon, rootfsused, rootfsbar, rootfspct, tab,
            upicon, txwidget, upgraph, upwidget, tab, tab,
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "`", function () scratch.drop("urxvtc", "top", "center", 1, 0.20, true) end),
