...
(use-package ruby-mode
  ...
  :hook
  (ruby-mode . nexus-ruby-mode-setup)

  :init
  (defun nexus-ruby-mode-setup ()
...
(use-package inf-ruby
  ...
  (inf-ruby-mode . nexus-inf-ruby-mode-setup)
  (compilation-filter . inf-ruby-auto-enter)

  :init
  (defun nexus-inf-ruby-mode-setup ()
    (company-mode -1))
...
(use-package rspec-mode
  :defer t
  :hook (rspec-mode . nexus-rspec-mode-setup)
...
(use-package rubocopfmt
  ...
  (rubocopfmt-rubocop-command
   (expand-file-name "bin/rubocop-daemon-wrapper" nexus-dir)))
...
(use-package ruby-tools
  ...
  :config
  ;; Unbind key used by nexus-resize-window module.
